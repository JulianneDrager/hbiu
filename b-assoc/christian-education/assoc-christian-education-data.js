const pagesData = [
  {
    ...
    imageUrl: "../../assets/img/course/aa-5.jpg",
    credits: 60 - 70,
    length: "2 YEARS",
    description: [
      `<div style='color: gray;' class='mb-10'><strong>Program Description</strong></div>`,
      `<div style='color: gray;' class='mb-10'>The Associate of Arts in Christian Education degree is tailored for individuals aspiring to serve in the establishment or management of Christian Education departments within churches and Christian schools. This program offers a comprehensive biblical and theological foundation for those pursuing careers as ministers of Christian education, children's ministry leaders, youth ministers, or adult ministry leaders.</div>`,
      `<div style='color: gray;' class='mb-10'><b>Foundational Courses</b></div>`,
      `<div style='color: gray;' class='mb-10'>These courses lay the essential groundwork for theological and biblical comprehension and are required for all students enrolling in a degree program at Logos University. They are compulsory for all undergraduate students.</div>`,
      ...
      `<div style='color: gray;' class='mb-10'><b>Core Concentration Courses</b></div>`,
      `<div style='color: gray;' class='mb-10'>Core concentration courses form the essential study for the major.</div>`,
