                        ...
                        <div class="widget category">
                            ...
                            <div class="category-list">
                                ...
                                <a href="../../../e-departments/e-main-human-social-sci/e-main-human-social-sci.html"><i
                                    ...
                                    <a href="../../../e-departments/e-main-business-law-economics/e-main-business-law-economics.html"><i
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="department-details">
                        ...
                        <div class="department-details">
                            ...
                            <div class="my-4">
                                <div class="mb-3">
                                    <h3 class="mb-3">${pageData.subTitle}</h3>
                                    <p>
                            ...
                            <div class="my-4">
                                <div class="mb-3">
                                    <h3 class="mb-3">${pageData.subTitle2}</h3>
                                    <p>
                            ...
                            <div class="my-4">
                                <div class="mb-3">
                                    <h3 class="mb-3">${pageData.subTitle3}</h3>
                                    <p>
                            ...
                            <div class="my-4">
                                <div class="mb-3">
                                    <h3 class="mb-3">${pageData.subTitle4}</h3>
                                    <p>
                            ...
                            <div class="my-4">
                                <div class="mb-3">
                                    <h3 class="mb-3">${pageData.subTitle5}</h3>
                                    <p>
                                ...
                                <div class="my-4">
                                <div class="mb-3">
                                    <h3 class="mb-3">${pageData.subTitle6}</h3>
                                    <p>
